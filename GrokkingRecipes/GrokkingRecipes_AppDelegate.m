...
/**
    ...
    store file.  This code uses a folder named "GrokkingRecipes" for
...
- (NSPersistentStoreCoordinator *) persistentStoreCoordinator {
    ...
    url = [NSURL fileURLWithPath: [applicationSupportFolder stringByAppendingPathComponent: @"GrokkingRecipes.xml"]];
